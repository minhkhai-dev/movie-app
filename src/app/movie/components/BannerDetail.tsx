...
export default function BannerDetail({ movie, cast, type }: { movie: Detail, cast: Casts[], type: string }) {
    ...
    return (
        <div className='w-full max-h-[100vh] bg-gray-950 overflow-hidden mb-10'>
            <div className='w-full sm:min-h-screen min-h-[60vh] bg-cover bg-center relative'
                style={{
            ...
            <div className='relative top-0 left-0 xl:-translate-y-[110%] lg:-translate-y-[90%] sm:-translate-y-[85%] -translate-y-2/3'>
                <div className='container-x flex lg:flex-row flex-col gap-x-[3%]'>
                    ...
                    <div className='w-full'>
                        <h1 className='lg:text-7xl md:text-4xl sm:text-3xl text-2xl text-white font-semibold mb-6 text-center lg:text-left'>{movie?.title || movie?.name}</h1>
                        ...
                        <div>
                            ...
                            <div className='my-3 flex sm:gap-x-4 gap-x-2 overflow-x-scroll scroll-smooth scroll-hidden' >
                                {cast?.map(ca => (
                                    <div key={ca.id}>
